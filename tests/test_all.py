...
class TestConversions(unittest.TestCase):
    ...
    def test_xyz(self):
        ...
        self.assertEqual(ct.xyz2rgb((0, 0, 0)), (0, 0, 0))
    ...
    def test_lab(self):
        ...
        self.assertEqual(ct.lab2rgb((0, 0, 0)), (0, 0, 0))
    ...
    def test_lch(self):
        ...
        self.assertEqual(ct.lch2rgb((0, 0, 0)), (0, 0, 0))
...
class TestDeltaEArgumentConfigurations(unittest.TestCase):
    ...
    def test_wrong_type_arguments(self):
        with self.assertRaises(TypeError):
            ct.deltaE76(self.lab1, "random_string")
        with self.assertRaises(TypeError):
            ct.deltaE94(self.lab1, "random_string")
        with self.assertRaises(TypeError):
            ct.deltaE_CMC(self.lab1, "random_string")
        with self.assertRaises(TypeError):
            ct.deltaE2000(self.lab1, "random_string")
        with self.assertRaises(TypeError):
            ct.deltaE76("random_string", self.lab2)
        with self.assertRaises(TypeError):
            ct.deltaE94("random_string", self.lab2)
        with self.assertRaises(TypeError):
            ct.deltaE_CMC("random_string", self.lab2)
        with self.assertRaises(TypeError):
            ct.deltaE2000("random_string", self.lab2)
...
class TestDeltaEResults(unittest.TestCase):
    ...
    def test_delta_e1976(self):
        ...
        assertCloseEqual(self, ct.deltaE76(self.lab5_int, self.lab6_int), 0.0)
    ...
    def test_delta_e1994(self):
        ...
        assertCloseEqual(self, ct.deltaE94(self.lab5_int, self.lab6_int), 0.0)
    ...
    def test_delta_e_CMC(self):
        ...
        assertCloseEqual(self, ct.deltaE_CMC(self.lab5_int, self.lab6_int), 0.0)
    ...
    def test_delta_e2000(self):
        ...
        assertCloseEqual(self, ct.deltaE2000(self.lab5_int, self.lab6_int), 0.0)
